...
set DESIGN_NAME $::env(TOP_NAME)
# set DESIGN_NAME [getenv TOP_NAME]
# Print out design name
puts "\[$COURSE_NAME\] Design name: $DESIGN_NAME"
# set RTL_SOURCE_FILES  [glob -nocomplain verilog/*.v verilog/*.sv verilog/*.vh *.svh]
# print out rtl source files
set sources [getenv SOURCES]
set RTL_SOURCE_FILES "sys_defs.svh $sources"
puts "\[$COURSE_NAME\] RTL source files: $RTL_SOURCE_FILES"
set NETLIST_FILES ""
set DESIGN_DEFINES ""
set DESIGN_PATH          "[pwd]"
set REPORTS_DIR "${DESIGN_PATH}/reports"
set RESULTS_DIR "${DESIGN_PATH}/results"
set CONSTRAINTS_FILE "${DESIGN_PATH}/constraints.tcl"
set USE_NUM_CORES $::env(MK_USE_NUM_CORES)
set ADDITIONAL_SEARCH_PATH "./ ../"
# set MEM_SUFFIX $::env(MK_MEM_SUFFIX)
set MEM_SUFFIX "1d05_25"
...
##### Custom
# Set SRAM instances as black boxes (test): not working
# set_black_box "weight_buffer_sram_inst"
# set_black_box "input_buffer_inst"
...
write -hier -format verilog -output ${DESIGN_NAME}.vg
